...
class K1yuanzgDB(AFXDataDialog):
    ...
    def __init__(self, form):
        ...
        AFXDataDialog.__init__(self, form, '\xd4\xb2\xd4\xfe\xb9\xf5\xb5\xa5\xb5\xc0\xb4\xce\xbd\xa8\xc4\xa3',
        ...
        fileName = os.path.join(thisDir, 'yuansan.png')
