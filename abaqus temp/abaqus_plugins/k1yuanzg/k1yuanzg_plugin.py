...
class K1yuanzg_plugin(AFXForm):
    ...
    def __init__(self, owner):
        ...
        self.cmd = AFXGuiCommand(mode=self, method='k1_yuanzg',
            objectName='yuanzgk1script', registerQuery=False)
        pickedDefault = ''
    ...
    def getFirstDialog(self):
        ...
        import k1yuanzgDB
        return k1yuanzgDB.K1yuanzgDB(self)
...
toolset.registerGuiMenuButton(
    buttonText='\xd4\xb2\xd4\xfe\xb9\xf5\xb5\xa5\xb5\xc0\xb4\xce\xbd\xa8\xc4\xa3', 
    object=K1yuanzg_plugin(toolset),
    messageId=AFXMode.ID_ACTIVATE,
    icon=None,
    kernelInitString='import yuanzgk1script',
