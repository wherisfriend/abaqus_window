...
import sys
sys.path.insert(8, 
    r'd:/abaqus_2021_tmp/Abaqus MainWindow GUI/abaqus temp/abaqus_plugins/yuankongxing')
import yuankong_fun
def k1_yuanzg(partname_k, alf_k, R_k, Dh_k, gunfeng_k, yanshen_k):
    yuankong_fun.yuankong(partname_k=partname_k, alf_k=alf_k, R_k=R_k, Dh_k=Dh_k, gunfeng_k=gunfeng_k, yanshen_k=yanshen_k)
