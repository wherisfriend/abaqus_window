...
class Hukongxingv1DB(AFXDataDialog):
    ...
    def __init__(self, form):
        ...
        AFXDataDialog.__init__(self, form, '\xbb\xa1\xc8\xfd\xbd\xc7\xbf\xd7\xd0\xcd\xbd\xa8\xc4\xa3',
        ...
        fileName = os.path.join(thisDir, 'huxing.png')
        ...
        AFXTextField(p=self, ncols=12, labelText='\xbb\xa1 \xcf\xdf \xbc\xd0 \xbd\xc7\xa6\xc2:', tgt=form.bateKw, sel=0)
