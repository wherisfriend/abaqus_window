...
class K1zhizgDB(AFXDataDialog):
    ...
    def __init__(self, form):
        ...
        AFXDataDialog.__init__(self, form, '\xc6\xbd\xc8\xfd\xbd\xc7\xbf\xd7\xd0\xcd\xb5\xa5\xb5\xc0\xb4\xce\xbd\xa8\xc4\xa3',
        ...
        fileName = os.path.join(thisDir, 'zhisan.png')
        ...
        AFXTextField(p=self, ncols=12, labelText='\xb9\xf5\xb7\xec\xbf\xed\xb6\xc8M\xa3\xba', tgt=form.gunfeng_kKw, sel=0)
